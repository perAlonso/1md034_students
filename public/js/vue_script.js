...
let floorBurger = new Burger('Floor-burger', 'some kind of bread', '(possibly suitable for vegans)', 'We don\'t know what it contains.', '1337', 'https://media-cdn.tripadvisor.com/media/photo-s/10/36/20/06/by-far-the-worst-burger.jpg', 'We found it on the floor, has', 'It may or may not contain meat ', 'Let\'s hope you\'re not allergic to something in it! ');
let otherBurger = new Burger('Some other burger', '(soggy and contains gluten)', 'It sure does contain meat', 'you probably don\'t want to eat this.', '1234', 'https://aht.seriouseats.com/assets_c/2014/02/20140203-sad-burger-dimly-lit-meals-for-one-thumb-300xauto-381436.jpg', 'White bread that was supposed to be my dinner ', 'Something something. ', 'Doesn\'t matter if you\'re allergic to something, ');
let notABurger = new Burger('This isn\'t even a burger', '', '', 'I don\'t think that\'s a burger...', '???', 'https://cdn.foodbeast.com/content/uploads/2016/05/Shitty-Food-Porn-1-408x450.jpg', 'Hold on!', 'I though we were selling burgers!!?!?!?', '');
...
const vm = new Vue({
	el: '#myID',
	data: {
		b1: floorBurger.heading(),
		b2: otherBurger.heading(),
		b3: notABurger.heading(),
		b4: meepBurger.heading(),
		b5: moopBurger.heading()
